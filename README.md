...
The project follows a complete analytics workflow, starting with initial Excel analysis and progressing through Python EDA, SQL business analysis, and Power BI dashboard development.

---

## 📌 Project Overview

Retail businesses operate across multiple products, customers, markets, and regions. Understanding where sales and profit are growing, declining, or remaining stagnant is important for improving business performance.

This project uses the **Global Superstore / DataCo supply chain dataset** to investigate:
...
- Discount patterns
- The relationship between discounts, sales, and profit
- Shipping and delivery performance
- Stagnant and declining sales
- Low- and negative-profit products

The objective is to transform transactional data into meaningful business insights that can support decisions related to **revenue growth, profitability, customer experience, and operational efficiency**.
...
- Identify operational areas that may affect customer experience
...
- Which regions experienced stagnant sales?
- Which products experienced stagnant sales?
- How much did sales decline compared with the previous month?
- Which regions generate the lowest revenue?
- Which product categories contribute the highest and lowest revenue?
- What are the top products generating the lowest revenue?
...
- Which customer segment experiences the longest average shipping time?
- Which countries have the longest average shipping time?
- How does shipping performance vary across regions and customer segments?
...
**Source:** Kaggle  
**Business Domain:** Retail Sales & Supply Chain Analytics
...
The dataset contains **3,788 unique product names** but **10,292 unique Product IDs**. Product Name is therefore primarily used for product-performance analysis, while Product ID can be used for SKU-level analysis.
...
⭐ **Project completed as a portfolio project to demonstrate practical data analysis and business problem-solving skills.**
